...
class InputEmbedder(nn.Module):
    ...
    def forward(self,
        ...
        node_sigma = torch.log(sigma.squeeze(dim=-1) / sigma_min) / np.log(sigma_max / sigma_min) * 10000
        ...
        pair_emb = self.pair_embedder(distance_rbf, nf_pair_emb, relative_pos, pair_mask)
...
class RigidDiffusion(nn.Module):
    ...
    def __init__(self,
                 num_blocks: int = 12, # StructureUpdateModule的循环次数
